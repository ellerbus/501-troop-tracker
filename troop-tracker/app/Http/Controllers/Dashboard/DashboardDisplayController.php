...
class DashboardDisplayController extends Controller
{
     ...
     * @param TrooperStatsRepository $stats The trooper statistics repository.
    ...
    public function __construct(
        ...
        private readonly TrooperStatsRepository $stats,
    ...
    public function __invoke(Request $request): View|RedirectResponse
    {
        ...
        $trooper = $this->troopers->getById($trooper_id);

        if ($trooper == null)
        {
            $this->flash->warning('Trooper could not be found');
