...
class TroopersDisplayControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_invoke_guest_is_redirected_to_login(): void
    {
        ...
        // Act
        $response = $this->get(route('admin.troopers.display'));
    ...
    public function test_invoke_unauthorized_user_is_forbidden(): void
    {
        ...
        $response = $this->actingAs($unauthorized_user)
            ->get(route('admin.troopers.display'));
    ...
    public function test_invoke_as_admin_shows_all_troopers(): void
    {
        ...
        // Assert
        $response->assertOk();
        $response->assertViewIs('pages.admin.troopers.display');
