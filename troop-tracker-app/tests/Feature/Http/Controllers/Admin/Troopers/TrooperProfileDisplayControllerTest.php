...
class TrooperProfileDisplayControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_invoke_guest_is_redirected_to_login(): void
    {
        ...
        // Act
        $response = $this->get(route('admin.troopers.trooper', $trooper));
    ...
    public function test_invoke_unauthorized_user_is_forbidden(): void
    {
        ...
        $response = $this->actingAs($unauthorized_user)
            ->get(route('admin.troopers.trooper', $target_trooper));
    ...
    public function test_invoke_authorized_user_can_view_profile(): void
    {
        ...
        // Assert
        $response->assertOk();
        $response->assertViewIs('pages.admin.troopers.trooper');
