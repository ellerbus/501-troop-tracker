 ...
 */
class OrganizationsDisplayController extends Controller
{
    /**
    ...
    public function __invoke(Request $request): View|RedirectResponse
    {
        ...
        $organizations = Organization::orderBy(Organization::SEQUENCE)->orderBy(Organization::NAME)->get();

        $data = [
            'organizations' => $organizations
        ];

        return view('pages.admin.organizations.display', $data);
    }
}
